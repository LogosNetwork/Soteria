  ...
  computed: {
    ...
    availableToBurn () {
      ...
      if (this.tokenAccount.decimals !== null) {
        ...
        return {
          text: `${parseFloat(amountInMajorUnit).toLocaleString(this.languageCode, { useGrouping: true })} ${this.tokenAccount.symbol} ${this.$t('areAvailableToBurn')}`,
          amount: amountInMajorUnit
        }
      } else {
        return {
          text: `${parseFloat(amountInMinorUnit).toLocaleString(this.languageCode, { useGrouping: true })} ${this.$t('minorUnitsOf')} ${this.tokenAccount.name} ${this.$t('areAvailableToBurn')}`,
